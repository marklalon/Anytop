...
def get_dataset(num_frames, split='train', temporal_window=31, t5_name='t5-base', balanced=False, objects_subset="all", sample_limit=0, use_reference_conditioning=True, action_tags='', motion_cache_size=0, fixed_motion='', fixed_window_start=0):
    dataset = Truebones(
        split=split,
