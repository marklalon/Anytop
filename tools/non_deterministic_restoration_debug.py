...
Description:
    Runs a one-shot full-schedule restoration workflow with stochastic training
    and stochastic restoration sampling.

    - Training samples diffusion timesteps from the full schedule via a schedule sampler.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="One-shot non-deterministic restoration with full-schedule training and stochastic sampling evaluation.")
