...
| `fk_angle_deg` bf16 | 11.978 | 12.015 | 11.342 | 11.183 | 11.968 |
| `fk_angle_deg` fp16 | 11.924 | 11.964 | 11.357 | 11.121 | 12.159 |

400 步内两条曲线的差在 0.1%–1.6%，属于逐步舍入分叉的正常范围，没有系统性偏向。fp16 run 随后跑满 200k 步，`l_simple` 0.1117 → 0.0307、`fk_angle_deg` 11.92 → 5.11，没有发散。
...
注意标量 loss 本身两边都已经在 1e-4 相对量级、彼此互有胜负（例如 200k 的 `fk_angle_deg`：fp16 1.4e-4、bf16 1.1e-4），那是 fp32 归约的噪声底，不构成反例。
