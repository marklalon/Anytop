...
def animation_from_positions(positions, parents, offsets=None, iterations=1, silent=False):
    ...
    # apply IK
    ik = BasicInverseKinematics(anim, positions, silent=silent, iterations=iterations, threshold=0.01)
    new_anim = ik()
